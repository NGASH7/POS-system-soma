...
<div class="soma-page">
    ...
    <div class="mb-8">
        ...
        <p class="text-slate-500 mt-2">Update branch outlet information</p>
    </div>
        ...
        <form method="POST" action="{{ route('admin.outlets.update', $outlet) }}">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="location" value="{{ old('location', $outlet->location) }}"
                           class="w-full px-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <input type="text" name="contact_info" value="{{ old('contact_info', $outlet->contact_info) }}"
                           class="w-full px-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div class="p-3 bg-slate-50 text-slate-600 text-sm rounded-xl border border-slate-200">
                    <i class="fas fa-info-circle mr-2 text-blue-500"></i>
                    Status cannot be deactivated for the main HQ branch or your currently active session branch.
                </div>
                @endif
            </div>
