        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 relative z-0">
            ...
            <div class="soma-card p-6 flex flex-col" style="height:420px;">
                ...
                <div class="flex-1 w-full relative min-h-0">
                    ...
                    @else
                        <canvas id="paymentChart" style="max-height:100%;"></canvas>
                    @endif
                </div>
            </div>

            <!-- Top Products -->
            <div class="soma-card p-6 h-[350px] overflow-hidden flex flex-col">
                                ...
                                generateLabels: function(chart) {
                                    ...
                                    if (data.labels.length && data.datasets.length) {
                                        return data.labels.map(function(label, i) {
                                            ...
                                            // Capitalise label and show percentage
                                            const niceName = label.charAt(0).toUpperCase() + label.slice(1).replace('_', ' ');
                                            return {
                                                text: niceName + ' ' + pct + '%',
                            ...
                            callbacks: {
                                label: function(context) {
                                    ...
                                    if (context.parsed !== null) {
                                        label += 'Ksh ' + new Intl.NumberFormat('en-KE').format(context.parsed);
                                    }
                                    return label;
                                }
                            }
